...
const Data=[
  ...
  
  {
    ...
    grade: 'CULTURAL RELAX',
    fees: '$700',
    description: 'One of the most remarkable Australian natural gifts is the Great barrier Reef. The hallnark of this place is lavish and beauty. Always Interesting to be in this place'
  },
...

  {
    ...
    grade: 'CULTURAL RELAX',
    fees: '$1100',
    description: 'A city in central Mexico, Guanajuato is known for its history of Silver mining and colonial architecture. The houses in the city are very bttractively painted with the most bright colors available. Always welcome.'
  },
